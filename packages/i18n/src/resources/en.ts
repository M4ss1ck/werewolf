...
export const en = {
  ...
  ui: {
    ...
    homeTagline:
      "The full moon rises over the village. Vote by day, hunt by night, and trust no one.",
    openGames: "Open games",
    noOpenGames: "No open games yet — the village is quiet. Create one and be the first to howl.",
    gameName: "Game name",
    gameNamePlaceholder: "e.g. The Full Moon Inn",
    ...
    scheduleInMinutes: {
      count_one: "In {{count}} minute",
      count_other: "In {{count}} minutes",
    },
    scheduleInHour: "In 1 hour",
    ...
    usernameHint: "3-24 characters: letters, numbers, spaces, hyphens or underscores.",
    chooseUsername: "Choose your username",
    chooseUsernameIntro: "Other players see this name in the lobby, the roster and the vote.",
